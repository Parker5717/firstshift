...
const Mascot = (() => {
  ...
  const PHRASES = {
    welcome: [
      "Привет! Я Алекс — твой помощник в первые дни на заводе. Покажу что к чему! 👋",
      "Добро пожаловать! Меня зовут Алекс. Не переживай — разберёмся вместе, шаг за шагом. 🚀",
      "Привет, я Алекс. Первый день — всегда волнительно, но у нас всё продумано. Начнём?",
    ],
    quest_start: [
      "Хорошо! Наведи камеру на объект и подержи пару секунд — система распознает.",
      "Поехали! Если потеряешься — смотри на подсказки внизу экрана.",
      "Этот квест займёт буквально пару минут. Главное — не спеши.",
    ],
    quest_complete: [
      "Отлично сделано! Вот так и нарабатывается опыт — задание за заданием. 💪",
      "Выполнено! Ещё несколько таких — и цех станет тебе как родной.",
      "Здорово! Я так и знал, что у тебя получится. Переходим дальше?",
    ],
    levelup: [
      "Новый уровень! Ты развиваешься быстрее, чем многие. Так держать! 🎉",
      "Уровень вырос! Твои знания о производстве заметно прибавились.",
      "Отличный результат! Продолжай в том же темпе. 🏆",
    ],
    idle: [
      "Видишь значок 🎯 внизу? Там задания — попробуй следующее!",
      "Наведи камеру на любой объект в цехе — вдруг найдём что-то интересное.",
      "Есть свободная минута? В заданиях ещё много полезного.",
    ],
    stress_relief: [
      "Не бойся ошибиться — здесь это разрешено. Обучение и есть проба. 😊",
      "Если что-то непонятно — спроси наставника. Глупых вопросов не бывает.",
      "Первый день — самый сложный. Уже завтра всё покажется проще, обещаю.",
      "Ты справляешься. Буквально каждый сотрудник начинал точно так же.",
    ],
    error: [
      "Не получилось — это нормально. Попробуй ещё раз, чуть подольше.",
      "Бывает! Иногда камере нужна пара секунд — подержи поближе к объекту.",
    ],
    safety_ok: [
      "Снаряжение в порядке! Безопасная смена начинается именно с этого.",
      "Каска и жилет на месте — всё правильно. Можно работать.",
    ],
  };
